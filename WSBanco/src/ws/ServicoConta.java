...
public class ServicoConta {
	...
	public String[] consultarDadosConta(int idConta, String senha) {
		...
		try {
			...
			System.out.println("Erro no serviço consultarDadosConta: " + erro.getMessage());
		}
	...
	public boolean cadastroConta(String nome, String senha) {
		...
		System.out.println("Dentro do método cadastroConta ");
		...
		try {
			...
			if (conta.cadastrar(nome, senha)) {
				...
				System.out.println("Conta não foi cadastrada!!!");
			...
			System.out.println("Erro no serviço de cadastro conta(cadastroConta): " + erro.getMessage());
	...
	public Integer cadastroContaNovo(String nome, String senha, int idConta) {
		...
		System.out.println("Dentro do método cadastroContaNovo");
		...
		try {
			...
			System.out.println("Erro no serviço cadastroConta: " + erro.getMessage());
		}
		return 0;
	}
	...
	public boolean saqueConta(double valor, int idConta, String senha) {
		...
		System.out.println("Dentro do método saqueConta!!!!!!!!!!!!!!!!!!!!");
		...
		try {
			...
			System.out.println("Erro no serviço saque de conta(saqueConta): " + e.getMessage());
	...
	public boolean depositoConta(double valor, int idConta, String senha) {
		...
		System.out.println("Dentro do método depositoConta!!!!!!!!!!! ");
		...
		try {
			...
			System.out.println("Erro no serviço depositoConta: " + e.getMessage());
		}
